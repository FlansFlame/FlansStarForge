package net.flansflame.flans_star_forge.entities.ai.stellar;

import net.flansflame.flans_star_forge.entities.ai.stellar.custom.ShockWaveStellarAttack;
import net.flansflame.flans_star_forge.entities.ai.stellar.custom.StabStellarAttack;
import net.flansflame.flans_star_forge.entities.ai.stellar.custom.SummonFollowerStellarAttack;
import net.flansflame.flans_star_forge.entities.ai.stellar.custom.ExplodeStellarAttack;
