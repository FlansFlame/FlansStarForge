...
public class FriendRenderer<T extends FriendEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public FriendRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends FriendEntity> extends GeoModel<T> {
        @Override
