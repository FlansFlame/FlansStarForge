...
public class FailedNovaRenderer<T extends FailedNovaEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public FailedNovaRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends FailedNovaEntity> extends GeoModel<T> {
        @Override
