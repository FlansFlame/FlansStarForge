...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, FlansStarForge.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        registries.remove(ModItems.INCOMPLETE_BEACON_OF_STAR);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = FlansStarForge.MOD_ID; // Change this to your mod id
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(), new ResourceLocation("item/generated")).texture("layer0", new ResourceLocation(FlansStarForge.MOD_ID, "item/" + item.getId().getPath()));
    }

    private ItemModelBuilder handheldItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(), new ResourceLocation("item/handheld")).texture("layer0", new ResourceLocation(FlansStarForge.MOD_ID, "item/" + item.getId().getPath()));
    }
}