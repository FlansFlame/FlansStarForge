...
public class StarsClusterRenderer<T extends StarsClusterEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public StarsClusterRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends StarsClusterEntity> extends GeoModel<T> {
        @Override
